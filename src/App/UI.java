	...
	public static void printBoard(ChessPiece[][] pieces) {
		for (int i = 0; i < pieces.length; i++) {
			...
			for (int j = 0; j < pieces.length; j++) {
				printPiece(pieces[i][j], false);//a cada passada printPiece recebe um endereço da matriz
			}
			System.out.println();
		}
...
//------------------novo printBoard	
	public static void printBoard(ChessPiece[][] pieces, boolean[][] possibleMoves) {
		for (int i = 0; i < pieces.length; i++) {
			System.out.print((8 - i) + " ");
			for (int j = 0; j < pieces.length; j++) {
				printPiece(pieces[i][j], possibleMoves[i][j]);//a cada passada printPiece recebe um endereço da matriz
			}
			System.out.println();
		}
		System.out.print("  a b c d e f g h");
